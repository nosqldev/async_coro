all: ev.o acoro.o echo_server echo_client infinite_connector chat_server coro_in_coro bg_worker libacoro.a
...
clean:
	- rm -f src/*.o ev/ev.o example/echo_server example/*.o example/core.* example/*.a example/echo_client example/infinite_connector example/chat_server example/coro_in_coro example/bg_worker
